...
concurrent binds without holding the environment lock, preserving the concurrent
evaluation safety requirement.
...
#### Scenario: Lock-free reads race-free with writes
