...
- [x] 1.1 Amend "Per-evaluation reduction and allocation counters": add that
...
- [x] 2.1 Amend "Fused native-op results charge the allocation ledger":
...
- [x] 2.2 Add a scenario/paragraph disclosing that a fused site's accounted
...
- [x] 3.1 CHANGELOG `[Unreleased]`: disclose both semantics for the readers
      of v0.10.0's release notes, which carried neither.
- [x] 3.2 Cross-reference note in `docs/adr/0011-reduction-and-allocation-metering.md`
...
- [x] 4.2 No code changes in this change — confirm `git diff` touches only
